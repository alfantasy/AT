...
script_description('Скрипт-плагин, внедряющий в AdminTool функцию рекона')
...
function sampev.onServerMessage(color, text)
	...
	-- <AC-WARNING> {ffffff}Jeff_507[34]{82b76b} подозревается в использовании чит-программ: {ffffff}Rapid fire [code: 026].
...
function EXPORTS.ActiveWarn()
    ...
    imgui.Text(fa.ICON_MINUS  .. u8" Показывать античит")
    imgui.SameLine()
    ...
    imgui.Separator()
    if imgui.Button(u8"Положение строк") then 
