...
function main()
	...
	sampfuncsLog(tag .. "Скрипт, отвечающий за репорты успешно подгружен.")
    ...
    while true do
		...
		if sampGetCurrentDialogEditboxText() == '.падм' or sampGetCurrentDialogEditboxText() == '/gflv' then
			sampSetCurrentDialogEditboxText('{FFFFFF}Ожидать набор, или же /help -> 18 пункт. | ' .. color() .. ' Приятной игры! ')
		end
		...
		if sampGetCurrentDialogEditboxText() == '.п13' or sampGetCurrentDialogEditboxText() == '/g13' then
			sampSetCurrentDialogEditboxText('{FFFFFF}Данную информацию можно найти в /help -> 14 пункт. | '  .. color() ..  ' Приятной игры на RDS. <3 ')
		end
